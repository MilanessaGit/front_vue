<template>
    <div class="grid">
        ...
        <div class="col-12">
            <Card>
                <template #title> DATOS DE ALMACEN </template>
                <template #content>
                <p></p>
                </template>
            </Card>
            ...
            <div class="grid">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <Button label="Guardar" icon="pi pi-check" class="p-button-text" @click="guardarAlmacen"></Button>
                    </div>
                </div>  
...
import Column from 'primevue/column';
    ...
    const guardarAlmacen = async () => {
        ...
        const {data} =await almacenService.guardar(datos_alm)
    }
